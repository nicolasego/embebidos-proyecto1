...
while [ 1 ]
do		
	#se le asigna a la variable temp el valor extraido del sensor
	temp=$(cat temperature)
	#se realiza el adecuamiento de este valor mediante la división por 1000 y se establece el numero de decimales
	temp=$(echo "scale=2; $temp/1000" | bc -l)"°C"
	#se agrega al archivo las dos columnas requeridas separadas por coma. las columnas son la fecha y la temperatura
